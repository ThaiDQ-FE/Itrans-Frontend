...
function ScheduleManagementInvestor() {
    ...
    const appointments = [];
    const listFreeTimeOfInvestor = useSelector((state) => state.freeTime.listFreeTimeOfInvestor);
    const listFreeTimeDetailOfInvestor = useSelector((state) => state.freeTime.listFreeTimeDetailOfInvestor);
    const detail1 = (schedule) => {
        let data = [];
        console.log(listFreeTimeDetailOfInvestor);
        for (let index = 0; index < listFreeTimeDetailOfInvestor.length; index++) {
            if (listFreeTimeDetailOfInvestor[index].id == schedule) {
                data = [{
                    ...
                    percentageoOfShares: listFreeTimeDetailOfInvestor[index].shareOrganization,
        ...
        for (let index = 0; index < listFreeTimeDetailOfInvestor.length; index++) {
            if (listFreeTimeDetailOfInvestor[index].id == schedule) {
                data = [{
                    ...
                    percentageoOfShares: listFreeTimeDetailOfInvestor[index].shareInvestor,
